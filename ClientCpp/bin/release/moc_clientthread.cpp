...
QT_MOC_LITERAL(3, 23, 12), // "displayError"
QT_MOC_LITERAL(4, 36, 28) // "QAbstractSocket::SocketError"

    },
    "ClientThread\0sendData\0\0displayError\0"
...
void ClientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ClientThread::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientThread::sendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientThread::sendData(QByteArray _t1)
{
